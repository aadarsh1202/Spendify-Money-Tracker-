...
const Login = () => {
  ...
  const responseGoogle = (response) => {
    ...
    axios
      .post("https://money-tracker-22.herokuapp.com/users", loginData)
      .then(function (response) {
        ...
        if (response.data.data.wallet_present === 0) {
          navigate("/wallet");
        } else {
          navigate("/home");
        }
